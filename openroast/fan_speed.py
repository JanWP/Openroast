...
- recipe_fan_speed: legacy recipe/editor scale (0..recipe_fan_max)
- runtime_fan_speed: backend-native runtime scale (0..runtime_fan_max)
...
- if runtime_fan_max == 1, every recipe value > 0 maps to 1
"""
