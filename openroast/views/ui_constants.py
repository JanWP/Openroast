...
class RecipeEditorUI:
    ...
    COLUMN_WIDTH_AFTER_FIRST_CRACK_COMPACT = 72
    COLUMN_WIDTH_AFTER_FIRST_CRACK_DEFAULT = 80
    ...
    AFTER_FIRST_CRACK_EDITOR_WIDTH_COMPACT = 66
    AFTER_FIRST_CRACK_EDITOR_WIDTH_DEFAULT = 72
    ...
    PICKER_AFTER_FIRST_CRACK_TITLE = "Set Time After 1st Crack"
