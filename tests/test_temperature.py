...
class TemperatureHelpersTests(unittest.TestCase):
    def test_normalize_temperature_unit_accepts_c_f_and_k(self):
        self.assertEqual(normalize_temperature_unit(" c "), TEMP_UNIT_C)
        self.assertEqual(normalize_temperature_unit("f"), TEMP_UNIT_F)
        self.assertEqual(normalize_temperature_unit("Kelvin"), TEMP_UNIT_K)
    ...
    def test_normalize_temperature_unit_falls_back_to_default(self):
        ...
        self.assertEqual(normalize_temperature_unit("kelvin", default=TEMP_UNIT_C), TEMP_UNIT_K)
    ...
    def test_temperature_to_celsius_uses_unit(self):
        ...
        self.assertAlmostEqual(temperature_to_celsius(273.15, TEMP_UNIT_K), 0.0)
    ...
    def test_celsius_to_temperature_unit_uses_unit(self):
        ...
        self.assertAlmostEqual(celsius_to_temperature_unit(100, TEMP_UNIT_K), 373.15)
...
class RecipeToCelsiusTests(unittest.TestCase):
    def test_recipe_to_celsius_converts_legacy_fahrenheit_when_unit_missing(self):
        ...
        self.assertEqual(normalized["formatVersion"], RECIPE_FORMAT_VERSION)
    ...
    def test_recipe_to_celsius_converts_kelvin_values(self):
        recipe = {
            "temperatureUnit": RECIPE_UNIT_KELVIN,
            "steps": [{"targetTemp": 373.15}],
        }
